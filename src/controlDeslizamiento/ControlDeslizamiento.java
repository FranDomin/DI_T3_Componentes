...
public class ControlDeslizamiento extends AnchorPane {
    ...
    {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("ControlDeslizamientoFXML.fxml"));
    ...
    private ObjectProperty<EventHandler<ActionEvent>> onAction = new ObjectPropertyBase<EventHandler<ActionEvent>>() 
    {
        ...
        {
            return ControlDeslizamiento.this;
        }
